...
<body style="height: 788px">
    ...
    <div style="height: 713px; background-color: #FFCC99;">
        ...
        <asp:Button ID="BtnBaja" runat="server" OnClick="BtnBaja_Click" style="z-index: 1; left: 402px; top: 136px; position: absolute; width: 88px; right: 418px" Text="Baja" />
        ...
        <asp:GridView ID="GrdAvalan" runat="server" Caption="Préstamos y sus avales" Enabled="False" OnRowDeleting="GrdAvalan_RowDeleting" style="z-index: 1; left: 423px; top: 225px; position: absolute; height: 152px; width: 232px" OnSelectedIndexChanged="GrdAvalan_SelectedIndexChanged">
            <Columns>
